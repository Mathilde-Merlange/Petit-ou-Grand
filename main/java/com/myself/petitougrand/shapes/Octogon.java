package com.myself.petitougrand.shapes;

import android.opengl.GLES30;

import com.myself.petitougrand.MySoloRenderer;
...
public class Octogon {
    ...
    private final short Indices[] = {0,4,5,0,1,4,3,6,7,2,3,7,0,4,7,1,2,6,3,4,0,5,6,1};
    ...
    public Octogon(float[] Pos) {
        ...
        int vertexShader = MySoloRenderer.loadShader(
                GLES30.GL_VERTEX_SHADER,
                vertexShaderCode);
        int fragmentShader = MySoloRenderer.loadShader(
