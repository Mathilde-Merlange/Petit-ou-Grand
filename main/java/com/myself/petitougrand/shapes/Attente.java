...
import com.myself.petitougrand.MyRenderer1;
...
//Dessiner un carré rouge de taille 4
 ...
 */
    ...
    public Attente(float[] Pos) {
        ...
        int vertexShader = MyRenderer1.loadShader(
                GLES30.GL_VERTEX_SHADER,
                vertexShaderCode);
        int fragmentShader = MyRenderer1.loadShader(
